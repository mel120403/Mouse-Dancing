...
changeVis('Armature', true);
changeVis('Camera', false);

operateAnimation('PLAY', 'Armature', 0, 99, 'AUTO', 1,
        function() {}, false);


registerOnClick('Ch14', false, false, [0,1,2], function() {
...
setShadowParam('Armature', 'CAST', 'ENABLE');

playSound(loadMedia_WebAudio('hello.mp3'), false);
